...
/*   Updated: 2023/11/21 12:44:19 by dcaro-ro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line_bonus.h"

static char	*ft_free_file(t_file **head, int fd)
{
	t_file	*prev;
	t_file	*temp;
